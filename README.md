...
2. Download the latest [release](https://github.com/Signynt/signynts-darkroom-shortcut/releases) [release](https://github.com/Signynt/signynts-darkroom-shortcut/archive/refs/tags/v1.0.zip) and open the zip file
